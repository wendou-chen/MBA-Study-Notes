...
exports.CodexidianView = exports.VIEW_TYPE_CODEXIDIAN = void 0;
const obsidian_1 = require("obsidian");
exports.VIEW_TYPE_CODEXIDIAN = "codexidian-view";
class CodexidianView extends obsidian_1.ItemView {
    ...
    getViewType() {
        return exports.VIEW_TYPE_CODEXIDIAN;
    }
    getDisplayText() {
        return "Codexidian";
    }
    ...
    async sendCurrentInput() {
        ...
        try {
            const result = await this.plugin.client.sendTurn(prompt, {
                onDelta: (delta) => {
                    var _a;
                    assistantEl.setText(((_a = assistantEl.textContent) !== null && _a !== void 0 ? _a : "") + delta);
                    this.scrollToBottom();
                },
                onToolDelta: (delta) => {
            ...
            if (((_a = assistantEl.textContent) !== null && _a !== void 0 ? _a : "").trim().length === 0) {
    ...
    updateStatus() {
        ...
        this.statusEl.setText(`${runningText} | ${threadText} | ${settings.approvalPolicy} | ${settings.sandboxMode}`);
...
exports.CodexidianView = CodexidianView;
