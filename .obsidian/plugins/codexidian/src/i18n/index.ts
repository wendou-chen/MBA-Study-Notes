...
const en = {
  ...
  cmdModelLabel: "Set Model",
  cmdModelDesc: "Choose a model override or return to the Codex CLI default.",
  ...
  noticeContextWindowSet: "Context window set to {size}",
  ...
  messageCliConfigWarning: "Codex CLI config warning: {error}",
  messageRuntimeReset: "Runtime settings changed. The next send will start a fresh backend thread.",
  messageRuntimeResetPending: "Runtime config changed during an active turn. It will apply after this turn completes.",
  ...
  noThread: "no thread",
  sourceCliShort: "CLI",
  sourceOverrideShort: "Override",
  statusRuntimePending: "pending refresh",
  defaultModel: "Default (follow Codex CLI config.toml)",
  ...
  settingCodexCommandDesc: "CLI command used to launch app-server. Leave as codex.cmd to follow the default Codex CLI config, or add args such as codex -p plus.",
  settingWorkingDirName: "Working directory",
  settingWorkingDirDesc: "Root directory Codex uses for this plugin session. Changing it starts a fresh backend thread.",
  settingModelName: "Model",
  settingModelDesc: "Optional model override. Leave blank to follow Codex CLI config.toml. Legacy built-in model values are reset to default.",
  customModelOption: "Custom model…",
  modelPrompt: "Enter a model override, or leave blank to follow Codex CLI config.toml.",
  settingEffortName: "Thinking effort",
  settingEffortDesc: "Control how deeply Codex thinks before responding.",
  settingCollaborationModeName: "模式",
  settingCollaborationModeDesc: "请求的审批模式：Safe、Prompt 或 Yolo。",
  settingContextWindowName: "上下文窗口大小",
  settingContextWindowDesc: "用于估算 token 使用量的上下文窗口上限。",
  settingContextWindowResolvedDesc: "Current effective window: {compact} ({exact}). Source: {source}.",
  settingResolvedSourceUnknown: "unknown",
  settingRuntimeStatusName: "Codex / CC Switch runtime",
  settingRuntimeStatusRefresh: "Refresh status",
  noticeRuntimeStatusRefreshed: "Codex runtime status refreshed.",
  runtimeStatusUnknown: "unknown",
  runtimeStatusConfigLine: "Config: {path}",
  runtimeStatusProviderLine: "Provider: {provider}",
  runtimeStatusModelLine: "Effective model: {model}",
  runtimeStatusEndpointLine: "Endpoint: {endpoint}",
  runtimeStatusRoutingLine: "Routing: {routing}",
  runtimeStatusCcSwitchLine: "CC Switch signal: {status}",
  runtimeStatusTokenLine: "Token: {token}",
  runtimeStatusRestartLine: "Restart Codexidian app-server after CC Switch provider or model catalog changes.",
  runtimeStatusLocalRouting: "local route detected",
  runtimeStatusDirectEndpoint: "direct provider endpoint",
  runtimeStatusCcSwitchDetected: "custom provider/model catalog detected",
  runtimeStatusCcSwitchNotDetected: "not detected",
  runtimeStatusTokenPresent: "provider token configured",
  runtimeStatusTokenMissing: "not detected",
  ...
  settingApprovalPolicyDesc: "Codex ask-for-approval mode for new or resumed threads. Changing it starts a fresh backend thread.",
  settingSandboxName: "Sandbox mode",
  settingSandboxDesc: "Sandbox mode for newly started or resumed threads. Changing it starts a fresh backend thread.",
  ...
  settingMcpContextLimitDesc: "Automatically attach top related notes to each prompt when MCP is enabled. Set to 0 to keep MCP tools enabled while disabling background note prefetch.",
  ...
  followCliModel: "{model} (CLI)",
  overrideModelLabel: "{model} (Override)",
  clearOverride: "Clear override",
  followCliContextWindow: "Follow CLI ({size})",
  customContextWindowOption: "Custom context window…",
  contextWindowPrompt: "Enter an exact token window size, or leave blank to follow Codex CLI.",
  contextWindowInvalid: "Please enter a positive integer token value.",
  noticeCliConfigWarning: "Codex CLI config warning: {error}",
...
const zh: typeof en = {
  ...
  cmdModelLabel: "设置模型",
  cmdModelDesc: "设置模型覆盖值，或切回 Codex CLI 默认模型。",
  ...
  noticeContextWindowSet: "上下文窗口已设置为 {size}",
  ...
  messageCliConfigWarning: "Codex CLI 配置警告：{error}",
  messageRuntimeReset: "运行时配置已变更；下一次发送会自动启动新的后端线程。",
  messageRuntimeResetPending: "运行中的回合检测到配置变化；将在本轮结束后自动生效。",
  ...
  noThread: "无线程",
  sourceCliShort: "CLI",
  sourceOverrideShort: "覆盖",
  statusRuntimePending: "待刷新",
  defaultModel: "默认（跟随 Codex CLI config.toml）",
  ...
  settingCodexCommandDesc: "用于启动 app-server 的 CLI 命令。保持 `codex.cmd` 可跟随默认 Codex CLI 配置；如需指定 profile，也可写成 `codex -p plus`。",
  settingWorkingDirName: "工作目录",
  settingWorkingDirDesc: "Codex 在本插件会话中使用的根目录。修改后会自动切到新的后端线程。",
  settingModelName: "模型",
  settingModelDesc: "可选的模型覆盖项。留空时跟随 Codex CLI 的 `config.toml`；旧的内置模型值会自动回退到默认。",
  customModelOption: "自定义模型…",
  modelPrompt: "输入模型覆盖值；留空则跟随 Codex CLI 的 `config.toml`。",
  ...
  settingContextWindowName: "Context window size",
  settingContextWindowDesc: "Max context window for token usage estimation.",
  settingContextWindowResolvedDesc: "当前生效窗口：{compact}（{exact}）。来源：{source}。",
  settingResolvedSourceUnknown: "未知",
  settingRuntimeStatusName: "Codex / CC Switch 运行状态",
  settingRuntimeStatusRefresh: "刷新状态",
  noticeRuntimeStatusRefreshed: "Codex 运行状态已刷新。",
  runtimeStatusUnknown: "未知",
  runtimeStatusConfigLine: "配置：{path}",
  runtimeStatusProviderLine: "Provider：{provider}",
  runtimeStatusModelLine: "生效模型：{model}",
  runtimeStatusEndpointLine: "端点：{endpoint}",
  runtimeStatusRoutingLine: "路由：{routing}",
  runtimeStatusCcSwitchLine: "CC Switch 信号：{status}",
  runtimeStatusTokenLine: "Token：{token}",
  runtimeStatusRestartLine: "通过 CC Switch 切换 provider 或模型目录后，请重启 Codexidian app-server。",
  runtimeStatusLocalRouting: "检测到本地转接路由",
  runtimeStatusDirectEndpoint: "直接连接第三方端点",
  runtimeStatusCcSwitchDetected: "检测到 custom provider / 模型目录信号",
  runtimeStatusCcSwitchNotDetected: "未检测到",
  runtimeStatusTokenPresent: "已配置 provider token（不显示明文）",
  runtimeStatusTokenMissing: "未检测到",
  ...
  settingApprovalPolicyDesc: "新建或恢复线程时使用的审批模式。修改后会自动切到新的后端线程。",
  settingSandboxName: "沙箱模式",
  settingSandboxDesc: "新建或恢复线程时使用的沙箱模式。修改后会自动切到新的后端线程。",
  ...
  settingMcpContextLimitDesc: "启用 MCP 时自动附加到每次提问的相关笔记数量。设为 0 可保留 MCP 工具能力，同时关闭后台笔记预取。",
  ...
  followCliModel: "{model}（CLI）",
  overrideModelLabel: "{model}（覆盖）",
  clearOverride: "清除覆盖",
  followCliContextWindow: "跟随 CLI（{size}）",
  customContextWindowOption: "自定义上下文窗口…",
  contextWindowPrompt: "输入精确 token 窗口大小；留空则跟随 Codex CLI。",
  contextWindowInvalid: "请输入正整数的 token 数值。",
  noticeCliConfigWarning: "Codex CLI 配置警告：{error}",
