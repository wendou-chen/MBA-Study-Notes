...
```
AGENTS.md / README.md        # 项目整体说明、规范、背景
.Codex/settings.json         # 项目级 AI 配置
...
- 如果项目同时使用 `.agent/` 和 `.Codex/`，将 skill 同步到两个位置
...
- [ ] Phase 0 已完成：读取了 README/AGENTS.md 和现有 skills
